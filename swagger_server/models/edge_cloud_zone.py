...
class EdgeCloudZone(Model):
    ...
    """
    def __init__(self, edge_cloud_zone_id: EdgeCloudZoneId=None, edge_cloud_zone_name: EdgeCloudZoneName=None, edge_cloud_zone_status: EdgeCloudZoneStatus=None, edge_cloud_provider: EdgeCloudProvider=None, edge_cloud_region: EdgeCloudRegion=None):  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'EdgeCloudZone':
    ...
    @property
    def edge_cloud_zone_id(self) -> EdgeCloudZoneId:
    ...
    def edge_cloud_zone_id(self, edge_cloud_zone_id: EdgeCloudZoneId):
    ...
    @property
    def edge_cloud_zone_name(self) -> EdgeCloudZoneName:
    ...
    def edge_cloud_zone_name(self, edge_cloud_zone_name: EdgeCloudZoneName):
    ...
    @property
    def edge_cloud_zone_status(self) -> EdgeCloudZoneStatus:
    ...
    def edge_cloud_zone_status(self, edge_cloud_zone_status: EdgeCloudZoneStatus):
    ...
    @property
    def edge_cloud_provider(self) -> EdgeCloudProvider:
    ...
    def edge_cloud_provider(self, edge_cloud_provider: EdgeCloudProvider):
    ...
    @property
    def edge_cloud_region(self) -> EdgeCloudRegion:
    ...
    def edge_cloud_region(self, edge_cloud_region: EdgeCloudRegion):
