...
from capabilities_exposure_api.models.application_models import AppManifest
...
def submit_app(body: dict):
    ...
    try:
        ...
        app_id = 3
        return jsonify({"message": "Application submitted successfully!", "appId": str(app_id)}), 201
